...
VERSION = 'V10-R14.3-RANGE-QUALITY-ENGINE'
...
def signals(r):
    ...
    if st=='RANGE':
        ...
        out['range_long']=bool(r.range_pos<=RANGE_POS_EDGE and bull_reject and long_reclaim and vol_ok and long_ctx and r.rsi<=55 and long_rr>=MIN_REWARD_RISK)
        out['range_short']=bool(r.range_pos>=1-RANGE_POS_EDGE and bear_reject and short_reclaim and vol_ok and short_ctx and r.rsi>=45 and short_rr>=MIN_REWARD_RISK)
